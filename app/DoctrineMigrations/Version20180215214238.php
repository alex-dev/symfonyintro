...
class Version20180215214238 extends AbstractMigration
{
  ...
  private function create(Schema $schema) {
    $this->addSql('CREATE TABLE Architectures (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, `key` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', discriminator VARCHAR(20) NOT NULL, UNIQUE INDEX UK_Architectures_key (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    $this->addSql('CREATE TABLE QuantityConverters (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, discriminator VARCHAR(20) NOT NULL, factor DOUBLE PRECISION DEFAULT NULL, offset DOUBLE PRECISION DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
