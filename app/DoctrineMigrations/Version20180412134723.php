...
class Version20180412134723 extends AbstractMigration
{
  public function up(Schema $schema)
  {
    ...
    $this->addSql('CREATE TABLE Orders (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, client BIGINT UNSIGNED NOT NULL, `key` BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid_binary)\', INDEX IDX_E283F8D8C7440455 (client), UNIQUE INDEX UK_Orders_key (`key`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    $this->addSql('CREATE TABLE OrderItems (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, `order` BIGINT UNSIGNED NOT NULL, product BIGINT UNSIGNED DEFAULT NULL, cost BIGINT UNSIGNED DEFAULT NULL, quantity INT UNSIGNED NOT NULL, INDEX IDX_7F568F95F5299398 (`order`), INDEX IDX_7F568F95D34A04AD (product), UNIQUE INDEX UNIQ_7F568F95182694FC (cost), UNIQUE INDEX UK_OrderItems_product_order (product, `order`), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
